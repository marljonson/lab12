...
public class FamilyTree {
    ...
    private void addLine(String line) throws TreeException
    {
        ...
        int colonIndex = line.indexOf(":"); //should be the index of the colon in line.git push -u origin main
    ...
    TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
    {
        ...
        if (node1 == null) {
            throw new TreeException("Node with name \"" + name1 + "\" doesn't exist");
        }
        TreeNode node2 = root.getNodeWithName(name2);        // node whose name is name2
        if (node2 == null) {
            throw new TreeException("Node with name \"" + name2 + "\" doesn't exist");
        }
    ...
    public static void main(String[] args) {
        try {
            FamilyTree tree = new FamilyTree("BagginsFamilyTree.txt");
